...
ace.define("ace/mode/astro", ["require", "exports", "module"], function (require, exports, module) {
  "use strict";
  
  const oop = require("ace/lib/oop");
  const HtmlMode = require("./html").Mode;
  ...
  const AstroHighlightRules = function () {
    ...
    const overwriteJSXendRule = (prefix) => {
      for (const index in this.$rules[prefix + "jsxAttributes"]) {
    ...
    overwriteJSXendRule("javascript-")
    overwriteJSXendRule("inline-js-")
  ...
  }.call(AstroMode.prototype)
  
  oop.inherits(AstroMode, HtmlMode);
  exports.Mode = AstroMode;
});
...
function main() {
  if (+BuildInfo.versionCode >= 292) {
    acode.require('aceModes').addMode('astro', 'astro', 'Astro');
  } else {
  ...
  styles[styles.length - 1].append(`
    span.file_type_default.file.file_type_astro:before {
      content: "";
      background: transparent;
    }
    .file.file_type_astro {
      background-image: url(data:image/svg+xml;base64,)!important;
    }
  `)
}
...
function destroy() {
  if (+BuildInfo.versionCode >= 292) {
    acode.require('aceModes').removeMode("astro")
  } else {
    window.toast("Restart App", 3000)
  }
}